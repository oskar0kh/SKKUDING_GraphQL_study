...
export namespace Prisma {
  ...
  */
  ...
  export type RestaurantOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"name" | "address" | "phone" | "rating" | "createdAt" | "updatedAt", ExtArgs["result"]["restaurant"]>
  ...
  export interface RestaurantDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
     * 
     * // Create many Restaurants and only return the `name`
     * const restaurantWithNameOnly = await prisma.restaurant.createManyAndReturn({
     *   select: { name: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Restaurants and only return the `name`
     * const restaurantWithNameOnly = await prisma.restaurant.updateManyAndReturn({
     *   select: { name: true },
     *   where: {
     *     // ... provide filter here
     *   },
